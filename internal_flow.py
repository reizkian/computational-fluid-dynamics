...
plt.xlabel("x")
plt.ylabel("y")
plt.title("MAGNITUDE KECEPATAN (t= 0.03 s)")
plt.show()
...
plt.xlabel("x")
plt.ylabel("y")
plt.title("MEDAN SKALAR TEKANAN (t= 0.03 s)")
plt.show()
...
plt.xlabel("x")
plt.ylabel("y")
plt.title("MAGNITUDE KECEPATAN (t= 0.06 s)")
plt.show()
...
plt.xlabel("x")
plt.ylabel("y")
plt.title("MEDAN SKALAR TEKANAN (t= 0.06 s)")
plt.show()
...
plt.plot(y_plot,u1_central,'r*-', label='t=0.03 sec')
plt.plot(y_plot,u2_central,'gx-', label='t=0.06 sec')
plt.plot(y_plot,u3_central,'bs-', label='t=0.1 sec')
plt.grid()
plt.xlabel('y')
plt.ylabel('u(y)')
...
plt.plot(x_plot,v1_central,'r*-', label='t=0.03 sec')
plt.plot(x_plot,v2_central,'gx-', label='t=0.06 sec')
plt.plot(x_plot,v3_central,'bs-', label='t=0.1 sec')
plt.grid()
plt.xlabel('x')
plt.ylabel('v(x)')
...
plt.plot(yp_plot,P_sx1,'r*-', label='t=0.03 sec')
plt.plot(yp_plot,P_sx2,'gx-', label='t=0.06 sec')
plt.plot(yp_plot,P_sx3,'bs-', label='t=0.1 sec')
plt.grid()
plt.xlabel('y')
plt.ylabel('P(x)')
